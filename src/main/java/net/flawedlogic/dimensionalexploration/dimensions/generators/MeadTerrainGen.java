...
import net.flawedlogic.dimensionalexploration.dimensions.generators.tools.GenTools;
import net.flawedlogic.dimensionalexploration.dimensions.generators.tools.ITGen;
...
public class MeadTerrainGen implements ITGen {
    private World world;
        ...
        for (int j1 = 0; j1 < 5; ++j1) {
            for (int k1 = 0; k1 < 5; ++k1) {
                ...
                for (int j2 = 0; j2 < 33; ++j2) {
                    ...
                    double d10 = GenTools.clamp(d7, d8, d9) - d6;
                    ...
                    for (int h = 0; h < 8; ++h) {
                        ...
                        for (int x = 0; x < 4; ++x) {
                            ...
                            for (int z = 0; z < 4; ++z) {
                                index += maxheight;
                                if (height < 2) {
                                    GenTools.setBlockState(primer, index, Blocks.BEDROCK.getDefaultState());
                                } else if ((d15 += d16) > 0.0D) {
                                	GenTools.setBlockState(primer, index, baseBlock);
                                } else {
                                	GenTools.setBlockState(primer, index, Blocks.AIR.getDefaultState());
                                }
                            }
